...
/*
  Determine if the letter grade of the given variable 'score'. If the variable is 90 or above, console log an 'A', between 80 and 89, console log a 'B', between 70 and 79, 'C', between 60 and 69, 'D', and anything below 60 should console log an 'F'.
*/
